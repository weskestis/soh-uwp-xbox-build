...
void BenMenu::AddSettings() {
    ...
    AddWidget(path, "about", WIDGET_CUSTOM).CustomFunction([](WidgetInfo& info) {
        ...
        ImGui::PopStyleColor();
        ImGui::SameLine();
        void* heartTextureId = std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->GetTextureByName(
...
void BenMenu::InitElement() {
    ...
    disabledMap = {
        ...
        { DISABLE_FOR_NO_MULTI_VIEWPORT,
          { [](disabledInfo& info) -> bool {
               return !std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())->SupportsViewports();
           },
