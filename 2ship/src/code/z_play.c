...
void Play_DrawMain(PlayState* this) {
    ...
    // before the actors emit theirs. Same Zelda3D_GL_* renderer serves soh/mm.
    ...
    if (1) {
        ...
        PauseRenderDraw:
            ...
            // Actor_DrawAll (G_ZELDA3D_DRAW -> Zelda3D_GL_Submit), interleaved with the N64 geometry in
            // the ONE render pass. No separate Zelda3D render-pass drain — same as OoT.
