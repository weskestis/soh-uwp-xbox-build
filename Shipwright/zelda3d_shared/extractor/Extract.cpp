...
int Extractor::ShowRomPickBox(uint32_t verCrc) const {
    ...
    Zelda3D_SDLSetMessageBoxButtonId(buttons[0], 0);
    buttons[0].text = "Yes";
    buttons[0].flags = SDL_MESSAGEBOX_BUTTON_RETURNKEY_DEFAULT;
    Zelda3D_SDLSetMessageBoxButtonId(buttons[1], 1);
    buttons[1].text = "No";
    buttons[1].flags = SDL_MESSAGEBOX_BUTTON_ESCAPEKEY_DEFAULT;
    Zelda3D_SDLSetMessageBoxButtonId(buttons[2], 2);
...
int Extractor::ShowYesNoBox(const char* title, const char* box) {
    ...
    Zelda3D_SDLSetMessageBoxButtonId(buttons[0], IDYES);
    buttons[0].text = "Yes";
    buttons[0].flags = SDL_MESSAGEBOX_BUTTON_RETURNKEY_DEFAULT;
    Zelda3D_SDLSetMessageBoxButtonId(buttons[1], IDNO);
    buttons[1].text = "No";
    buttons[1].flags = SDL_MESSAGEBOX_BUTTON_ESCAPEKEY_DEFAULT;
