...
void TimeDisplayWindow::InitElement() {
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())
        ->LoadGuiTexture("GAMEPLAY_TIMER", gClockIconTex, Ship::Color4f(1, 1, 1, 1));
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())
        ->LoadGuiTexture("DAY_TIME_TIMER", gSunIconTex, Ship::Color4f(1, 1, 1, 1));
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())
        ->LoadGuiTexture("NIGHT_TIME_TIMER", gMoonIconTex, Ship::Color4f(1, 1, 1, 1));
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())
        ->LoadGuiTexture("NAVI_TIMER", gNaviIconTex, Ship::Color4f(1, 1, 1, 1));

    for (auto& load : digitList) {
        std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetRawInstance()->GetWindow()->GetGui())
            ->LoadGuiTexture(load.first.c_str(), load.second, Ship::Color4f(1, 1, 1, 1));
    }
